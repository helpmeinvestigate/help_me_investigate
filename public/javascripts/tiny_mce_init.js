tinyMCE.init({
  mode : "exact",
  elements : "mceEditor,post_raw_post,faq_answer,user_description",
  theme : "advanced",
  plugins : "style,layer,table,save,advhr,emotions,ts_advimage,iespell,preview,advmedia,searchreplace,print,contextmenu,paste,directionality,fullscreen,noneditable,visualchars,nonbreaking,xhtmlxtras,template,insertcode",
