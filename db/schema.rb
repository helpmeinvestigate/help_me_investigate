...
ActiveRecord::Schema.define(:version => 20090818170453) do
  ...
  create_table "blanks", :force => true do |t|
    t.integer  "user_id"
    t.integer  "investigation_id"
    t.string   "blank_type",       :limit => 16, :default => "thing"
  ...
  create_table "comments", :force => true do |t|
    ...
    t.string   "link"
    t.string   "answer"
    t.string   "published_as",                   :default => "live"
    t.datetime "published_at"
    t.string   "short_link"
    t.integer  "investigation_id"
    t.string   "bitly_hash"
    t.string   "link_title"
    t.string   "bitly_user_hash"
    t.integer  "shorten_attempts",               :default => 0
  end
  ...
  create_table "investigatings", :force => true do |t|
    t.integer  "user_id"
    t.integer  "investigation_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "investigations", :force => true do |t|
    ...
    t.string   "published_as",         :limit => 16, :default => "draft"
    t.datetime "published_at"
    t.integer  "investigatings_count",               :default => 0
    t.boolean  "locked"
    t.boolean  "completed"
  ...
  add_index "posts", ["published_as"], :name => "index_investigations_on_published_as"
  add_index "posts", ["published_as"], :name => "index_posts_on_published_as"
  add_index "posts", ["published_at"], :name => "index_investigations_on_published_at"
  add_index "posts", ["published_at"], :name => "index_posts_on_published_at"
  add_index "posts", ["user_id"], :name => "index_investigations_on_user_id"
  ...
  create_table "simple_cms_images", :force => true do |t|
    t.integer "parent_id"
    t.string  "content_type"
    t.string  "filename"
    t.string  "thumbnail"
  ...
  create_table "simple_cms_item_versions", :force => true do |t|
    t.integer  "simple_cms_item_id"
    t.integer  "version"
    t.string   "params"
    t.text     "data"
    t.integer  "position"
  ...
  create_table "simple_cms_items", :force => true do |t|
    t.string   "params"
  ...
  create_table "simple_cms_medias", :force => true do |t|
    t.integer "parent_id"
    t.string  "content_type"
    t.string  "filename"
    t.string  "thumbnail"
  ...
  create_table "solutions", :force => true do |t|
    ...
    t.text     "description"
    t.integer  "investigation_id"
    t.string   "published_as",     :limit => 16, :default => "live"
    t.datetime "published_at"
    t.datetime "created_at"
    t.datetime "updated_at"
  end
  ...
  create_table "users", :force => true do |t|
    ...
    t.integer  "role_id"
    t.boolean  "notify_investigations",                   :default => true
