class Invitation < ActiveRecord::Base
  ...
  #TODO asserts investigation is_being_investigated_by user
  ...
  def send_invite
    ...
    emails.each{|email|
      ...
      unless self.investigation.blank?
        UserNotifier.deliver_investigation_invitation(email, self.user, self.investigation, self.message)
      else
